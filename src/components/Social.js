const links = [
  ...
  {
    href: "https://www.youtube.com/@UsamaImdad",
    label: "YouTube",
    icon: (
  ...
  {
    href: "https://www.upwork.com/freelancers/~011205f723950c7f04",
    label: "Upwork",
    icon: (
      <svg viewBox="0 0 448 512" aria-hidden="true">
  ...
  {
    href: "https://github.com/usamaimdadsian/",
    label: "GitHub",
    icon: (
  ...
  {
    href: "https://www.linkedin.com/in/usama-imdad/",
    label: "LinkedIn",
    icon: (
      <svg viewBox="0 0 448 512" aria-hidden="true">
