...
const web = [
  {
    ...
    skills: [
      ...
      {
        key: "Database & Cloud",
        value: "MySQL, SQLite, Linux VPS, Docker, Redis, Azure"
      },
      {
        key: "Frameworks & Tools",
        value: "React JS, Vue JS, Node JS, Laravel"
      },
    ]
  },
  {
    ...
    headings: [
      {
        ...
        date: "Feb 2023 - Present",
        items: [
          "Designed a circuit for serial communication with the card scanner and developed code to read hex values from the RFID cards for the product payments on vending machines.",
          "Integrated MQTT-based pub/sub architecture in ESP32, enabling the ESP to send heartbeats to the cloud only when requested, reducing AWS cloud costs.",
          "Developed React-based front-end dashboard for vending machine management, encompassing user-friendly interfaces, backend API integration, and real-time data insights for streamlined management, enhanced efficiency, and improved decision-making.",
        ]
      },
      {
